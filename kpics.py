...
def thumb(_photo_path):
    _thumb_dir = r'C:\Users\kogut\Documents\.S19_Babica'
...
if __name__ == '__main__':
    ...
    for _photo_id in _photos:
        ...
        if os.path.isfile(_path): # check if file exists 
...
_template_head_path = r'C:\Users\kogut\knode\template\head_index.html'
_template_end_path = r'C:\Users\kogut\knode\template\end_index.html'
_css = r'C:\Users\kogut\knode\template\index.css'
html = ''
...
shutil.copy2(_css, os.path.join(_thumb_dir_path, os.path.basename(_css)))